...
import { AdvancedAnalytics } from '@/components/admin/financial/AdvancedAnalytics';
      ...
      <Tabs defaultValue="overview" className="space-y-6">
        ...
        <TabsContent value="trends">
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Analyses des tendances saisonnières et prédictions à venir...
              </p>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="comparison">
          <Card>
            <CardHeader>
              <CardTitle>Comparaisons entre Points de Vente</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
                Comparaisons de performance entre différents magasins...
              </p>
            </CardContent>
          </Card>
        </TabsContent>
