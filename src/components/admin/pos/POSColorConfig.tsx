...
export const POSColorConfig = ({ config, onUpdate, canEdit, previewConfig }: POSColorConfigProps) => {
  const colorPresets = [
    ...
    <div className="grid lg:grid-cols-2 gap-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Personnalisez la palette de couleurs du POS. Les modifications sont visibles en temps réel dans l'aperçu.
          </CardDescription>
        </CardHeader>
