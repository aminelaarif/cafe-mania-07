...
export const POSLayoutConfig = ({ config, onUpdate, canEdit, previewConfig }: POSLayoutConfigProps) => {
    ...
    <div className="grid lg:grid-cols-2 gap-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Personnalisez l'organisation visuelle du POS. Les modifications sont visibles en temps réel dans l'aperçu.
          </CardDescription>
        </CardHeader>
